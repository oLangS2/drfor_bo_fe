...
// 등급 등록 팝업
export const GradeCreatePop = ({ onClose, onApi, funCancel }) => {
	// ---------------------------------------------------------------
	// 초기 변수 설정
	// ---------------------------------------------------------------
		...
		if (gradeValue.gradeGroupNo)
			try {
				const res = await LmAxios({
					...
					data: {
						gradeGroupNo: gradeValue.gradeGroupNo,
	...
	return (
		<div className="lm-pop-container">
			<div className="lm-pop-title mb-24">회원등급 등록</div>
			<div className="lm-line-bottom"></div>
			<div className="lm-input-box-wrap">
				<div className="lm-input-box-wrap-title">등급번호</div>
				<input
					name="gradeGroupNo"
					type="text"
			...
			<div className="lm-input-box-wrap">
				<div className="lm-input-box-wrap-title">등급명</div>
				<input
					name="gradeName"
					type="text"
					className="lm-input s-s"
